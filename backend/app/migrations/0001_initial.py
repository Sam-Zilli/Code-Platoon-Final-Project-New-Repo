# Generated by Django 4.1.7 on 2023-03-08 02:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shoulder_max', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('shoulder_min', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('chest_max', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('chest_min', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('sleeve_max', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('sleeve_min', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('length_max', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('length_min', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
